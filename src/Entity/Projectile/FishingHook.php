...
namespace PracticeCore\Entity\Projectile;
...
use PracticeCore\Entity\Projectile\Behaivor\IFishingBehaviorEntity;
...
class FishingHook extends Projectile{
	...
	public function canCollideWith(Entity $entity) : bool{
		...
		if($player instanceof Player && $entity instanceof Player && $player->getName() !== $entity->getName() && $target->getName() !== $entity->getName()){
			return false;
		}
	...
	protected function onHitEntity(Entity $entityHit, RayTraceResult $hitResult) : void{
		...
		if(($owner = $this->getOwningEntity()) !== null && !$entityHit->isSilent()){
			...
			if($owner instanceof Player && $owner->getId() !== $entityHit->getId()){
				$owner->broadcastSound(new XpCollectSound(), [$owner]); // random.orb
			}
		}
	}
}
